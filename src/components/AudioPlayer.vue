<template>
  <div class="audio-player" v-if="files.length > 0">
    ...
    <div class="player-progress-wrapper">
      ...
      <div class="player-progress-bar" @mousedown="onProgressMouseDown" ref="progressBarRef">
    ...
    <div class="player-controls">
      <button class="player-btn player-btn-sm" @click="previous" :title="t('player_previous')">
      ...
      <button class="player-btn player-btn-sm" @click="stop" :title="t('player_stop')">
        <svg viewBox="0 0 24 24" width="18" height="18">
      ...
      <button class="player-btn player-btn-sm" @click="next" :title="t('player_next')">
        <svg viewBox="0 0 24 24" width="18" height="18">
...
<style scoped>
  .audio-player {
    margin-top: 20px;
    padding: 20px;
    background: linear-gradient(135deg, rgba(14, 28, 50, 0.6), rgba(14, 28, 50, 0.4));
  ...
  .light-theme .audio-player {
    background: linear-gradient(135deg, rgba(245, 244, 214, 0.6), rgba(248, 225, 169, 0.3));
  }
